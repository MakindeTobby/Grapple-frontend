...
function DashboardCard11() {
  ...
  return (
    <div className="col-span-full xl:col-span-5 bg-white shadow-lg rounded-sm border border-slate-200">
      <header className="px-7 py-4 border-b border-slate-100 flex justify-between cursor-pointer">
       <div> <h2 className="font-semibold text-slate-800">Health Forum Feedback</h2></div>
        {/* <div className="flex m-2 justify-between"> */}
          <div className=' lg:bg-red-600 lg:px-3 lg:rounded-xl lg:text-white sm:px-2'><h5>March</h5> </div>
          <div className='hover:bg-red-600 px-3 rounded-xl hover:text-white text-black'> <h5>Febuary</h5></div> 
          <div className='hover:bg-red-600 px-3 rounded-xl hover:text-white text-black'> <h5>January</h5></div>
          {/* </div> */}
      </header>
